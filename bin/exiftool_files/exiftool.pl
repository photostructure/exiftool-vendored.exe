  ...
  Option Details
   ...
   Input-output text formatting
    ...
    -charset [[*TYPE*=]*CHARSET*]
         ...
         *TYPE* may be "FileName" to specify the encoding of file names on
         ...
         See <http://exiftool.org/faq.html#Q10> for more information about
    ...
    -struct, --struct
         ...
         <http://exiftool.org/struct.html> for details). When copying,
   ...
   Processing control
    ...
    -ee (-extractEmbedded)
         ...
         videos. See <http://exiftool.org/geotag.html#Inverse> for examples.
   ...
   Advanced options
    ...
    -config *CFGFILE*
         ...
         <http://exiftool.org/config.html> and config_files/example.config
...
WINDOWS UNICODE FILE NAMES
    ...
    <http://exiftool.org/faq.html#Q18> for details), so placing them in a
...
WRITING EXAMPLES
    ...
    exiftool -hierarchicalkeywords="{keyword=one,children={keyword=B}}"
         ...
         <http://exiftool.org/struct.html> for more details.
...
RENAMING EXAMPLES
    ...
    <http://exiftool.org/filename.html> for additional documentation and
    examples.
...
GEOTAGGING EXAMPLES
    ...
    <http://exiftool.org/geotag.html> for additional documentation.
